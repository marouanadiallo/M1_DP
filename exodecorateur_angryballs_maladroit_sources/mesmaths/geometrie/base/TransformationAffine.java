...
/**
 * cree l'homothetie affine de coefficient "k" et de centre "centre" 
 * 
 * Soit P un point quelconque et P' son image par la transfo T creee. Soient k le coeff et C le centre, alors T respecte la condition suivante :
 *  vecteur(CP') = k*vecteur(CP')
 * 
 * @param k : coefficient de l'homothetie
 * @param centre : centre de l'homothetie
 * 
 * */
public static TransformationAffine creeHomothetie(double k, Vecteur centre)
{
/*Matrice R = Matrice.creeMatriceDiagonale(k, k);
Vecteur u = centre.difference(R.produit(centre));
return new TransformationAffine(R, u);*/
...
/**
 * cree une transformation affine avec point invariant
 * 
