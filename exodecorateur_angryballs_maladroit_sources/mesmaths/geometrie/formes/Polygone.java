...
/** represente un polygone ferme */
public class Polygone
{
Vecteur t[]; // Le dernier point n'est pas recopie, ne contient donc pas d'information redondante

/**
 * @param t : tableau d'au moins 3 points distincts : c'est le tableau contenant les sommets du polygene
 * 
...
/**
 * modifie this en appliquant transfo e tous les points qui composent this
 * 
 * */
